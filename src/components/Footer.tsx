      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-muted/50 leading-relaxed max-w-xs">
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-sm text-muted/50 hover:text-accent transition-colors duration-150"
                  >
                    {link.label}
                  </a>
                </li>
        ...
        <div className="pt-6 border-t border-border/20 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <a
              href="#"
              className="text-[11px] text-muted/30 hover:text-accent/60 transition-colors duration-150 font-mono"
            >
              Privacidade
            </a>
            <a
